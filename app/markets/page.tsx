...
export default function MarketsPage() {
  ...
  return (
    <SentryErrorBoundary name="markets-page">
        ...
        <div className="container max-w-7xl mx-auto p-4 space-y-4">
          <div className="grid grid-cols-3 gap-4">
            <div className="col-span-2">
              <SentryErrorBoundary name="market-insights">
                <MarketInsights />
              </SentryErrorBoundary>
            </div>
            <SentryErrorBoundary name="market-indices">
              <MarketIndices />
            </SentryErrorBoundary>
          </div>

          <SentryErrorBoundary name="kalshi-markets">
            <KalshiMarkets />
          </SentryErrorBoundary>
          ...
          <div className="bg-card border">
            ...
            <div className="p-4">
              <SentryErrorBoundary name="stock-chart">
          ...
          <div className="grid grid-cols-2 gap-4">
            <SentryErrorBoundary name="top-movers-gainers">
              <TopMovers type="gainers" />
            </SentryErrorBoundary>
            <SentryErrorBoundary name="top-movers-losers">
