...
const structuredData = {
  ...
  "@type": "CollectionPage",
  name: "Live Markets Dashboard",
  description:
    "Monitor indices, prediction markets, and real-time gainers and losers inside the Datax Terminal markets workspace.",
  url: getCanonicalUrl("/markets"),
  hasPart: [
    {
      "@type": "Dataset",
      name: "Global Indices Snapshot",
      description: "Real-time performance for major equity indices and benchmarks.",
    },
    {
      "@type": "Dataset",
      name: "Top Movers",
      description: "Daily lists of leading equity gainers and decliners.",
    },
    {
      "@type": "Dataset",
      name: "Prediction Markets",
      description: "Kalshi contracts covering macro and event-driven scenarios.",
    },
  ],
  potentialAction: {
    "@type": "SearchAction",
    target: `${getCanonicalUrl("/markets")}?symbol={symbol}`,
...
export default function MarketsPage() {
  ...
  return (
    <div className="flex h-screen">
      <Script id="markets-ld-json" type="application/ld+json" strategy="afterInteractive">
