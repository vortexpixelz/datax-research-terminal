...
const structuredData = {
  ...
  description:
    "Configure Groq and Polygon API keys, manage credentials, and review security information for the Datax Terminal.",
  url: getCanonicalUrl("/settings"),
  potentialAction: {
    "@type": "AuthorizeAction",
    target: getCanonicalUrl("/settings"),
    description: "Store API credentials locally to unlock real-time AI and market data.",
  },
}
...
export default function SettingsPage() {
  ...
  return (
    <div className="flex h-screen">
      <Script id="settings-ld-json" type="application/ld+json" strategy="afterInteractive">
