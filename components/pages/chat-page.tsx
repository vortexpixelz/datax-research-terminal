...
const structuredData = {
  ...
  "@type": "WebApplication",
  name: "Datax Market Research Terminal",
  description:
    "Ask AI-powered questions about equities, monitor market events, and surface investment insights in real time.",
  ...
  potentialAction: {
    ...
    target: getCanonicalUrl("/"),
    description: "Submit a market research question to the AI assistant.",
  },
}
...
export default function ChatPage() {
  ...
  return (
    <div className="flex h-screen">
      <Script id="chat-ld-json" type="application/ld+json" strategy="afterInteractive">
