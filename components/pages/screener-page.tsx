...
const structuredData = {
  ...
  description:
    "Screen equities by fundamentals, technicals, and custom filters using the Datax Terminal stock screener.",
  url: getCanonicalUrl("/screener"),
  potentialAction: {
    "@type": "SearchAction",
    target: `${getCanonicalUrl("/screener")}?q={search_term}`,
...
export default function ScreenerPage() {
  ...
  return (
    <div className="flex h-screen">
      <Script id="screener-ld-json" type="application/ld+json" strategy="afterInteractive">
