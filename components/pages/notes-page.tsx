...
const structuredData = {
  ...
  description:
    "Capture, organize, and interlink equity research notes with graph visualizations inside the Datax Terminal.",
  ...
  potentialAction: {
    "@type": "CreateAction",
    target: getCanonicalUrl("/notes"),
    description: "Create and link a new investment research note.",
  },
}
...
export default function NotesPage() {
  ...
  return (
    <div className="flex h-screen">
      <Script id="notes-ld-json" type="application/ld+json" strategy="afterInteractive">
